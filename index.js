...
function showTime() {
  document.querySelector('.minutes').innerText = time.minutes < 10 ? '0' + time.minutes + 'm' : time.minutes + 'm';
  document.querySelector('.seconds').innerText = time.seconds < 10 ? '0' + time.seconds + 's' : time.seconds + 's';
  document.querySelector('.miliseconds').innerText = time.miliseconds < 10 ? '0' + time.miliseconds + 'ms' : time.miliseconds + 'ms';
}
